  ...
  return (
    <>
      ...
      <div className="space-y-4">
        {goals.map((goal) => (
          <div className="flex flex-col justify-start">
            ...
            <div className="w-3/4 bg-gray-300 rounded-full h-2 my-2">
              <div
      ...
      <div className="flex flex-row gap-8 justify-start mt-4 mb-8">
        ...
        <div className="relative w-16 h-16 bg-gray-500 rounded-3xl transform rotate-45 hover:scale-105 transition duration-200 ease-in-out">
          <div className="absolute inset-0 flex justify-center items-center">
