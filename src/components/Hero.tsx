        ...
        <div className="flex flex-row gap-4">
          <div>
            <h2 className="font-semibold text-xl text-black mb-4">
              <span className="inline border-b-4 border-primary pb-1">Step 1.</span> Buy a lottery ticket
            </h2>
          ...
          <div>
            <h2 className="font-semibold text-xl text-black mb-4">
              <span className="inline border-b-4 border-primary pb-1">Step 2.</span> Enter your code
            </h2>
          ...
          <Card className="shadow-md px-4 py-4">
            <CardContent className="flex gap-4">
              <div className="flex flex-col gap-4 w-5/12 justify-between">
                <p>
                  Choose a cause that you'd like to support. The more votes a cause
                  gets, the more likely we will make a crazy video about it. Even if your cause doesn't win, we'll still donate to it.
                </p>
                <Button
